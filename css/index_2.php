                    ...
                    <div class="main">
                      <article class="grid_7">
                          <?php
                            ...
                            {
                                $description = substr($row[tWebPageDesc], 0, 200);
                               echo <<<HTML
                                <div class="grid_30">
<div><h4>$row[vWebPageName]</h4></div>
<div class="img_grid">
<img src="admin/banner/$row[vWebImage]" alt="" width="101" height="110"/>
</div>
<div>$description</div>
<p>
<a class="readmore back" href="inner-index.php?id=$row[iWebPageId]">View more &gt;&gt;</a>
  </p>
             </div>
HTML;
                            }?>
