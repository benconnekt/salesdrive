...
<html lang="en">
<head>
    <title>Telesales | Seminars & Events Bookings | Sales Leads | Telemarketing</title>
    <meta charset="utf-8">
                ...
                <div class="blockmain">
                    <div class="main">
                        <article class="grid_7">
                          <h5>Seminars & Events Booking</h5>
                          <? $sqlkey="select * from webpages WHERE iCateoryId = 3 AND  isubCateoryId = 17"; 
