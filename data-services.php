...
<html lang="en">
<head>
    <title>B2B Database Management Sourcing & Cleansing | Sales Oxfordshire Services</title>
    <meta charset="utf-8">
                ...
                <div class="blockmain">
                    <div class="main">
                        <article class="grid_7">
                          <h5>Data &amp; Research</h5>
                          <? $sql="select * from webpages WHERE iCateoryId = 3 AND  isubCateoryId = 13"; 
                             $data = $obj->select($sql);
                            $num_row = count($data);
                        $rows=0;
                        for($m=0;$m<$num_row;$m++)
