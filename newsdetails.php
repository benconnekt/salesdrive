...
<html lang="en">
<head>
    <title>Sales Drive News | Reputable Telemarketing Agency |Specialists</title>
    <meta charset="utf-8">
                ...
                <div class="blockmain">
                    <div class="main">
                        <article class="grid_7">
                          ...
                          <? 
                            $sql="select * from news WHERE iNewsId = '".$_GET['id']."' "; 
                            $news = $obj->select($sql);
                            $num_row = count($news);
                            $rows=0;
                                for($m=0;$m<$num_row;$m++)
                            ...
                            <article>
                              ...
                              $date = date("l, F d, Y",strtotime($news[$m]['vNewDate']));?>     
                               <h6 style="color: #37A8CA; font-size: 14px"> <?=$date;?></h6>
                                <?=  stripslashes($news[$m]['tNewDesc']);?>
                            </article>
                            <div class="clear"></div>
                        </aside>
                          <p style="text-align: center; font-size: 18px;"><a href="archive.php">View All News</a></p>
