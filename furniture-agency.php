...
<html lang="en">
<head>
    <title>Furniture UK Agent | Specialist Import Agency Promoting Products</title>
    <meta charset="utf-8">
                ...
                <div class="blockmain">
                    <div class="main">
                        <article class="grid_7">
                          <h5>furniture Agency</h5>
                          <? $sqlkey="select * from webpages WHERE iCateoryId = 3 AND  isubCateoryId = 15"; 
