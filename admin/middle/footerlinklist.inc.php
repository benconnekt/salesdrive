...
$sql="select count(*) as tot from footerlink where 1=1 ".$ssql;
$db_res=$obj->select($sql);	
$num_totrec = $db_res[0]["tot"];

include("middle/paging.inc.php");

$db_query = "select * from footerlink ". $var_limit;
...
$TOP_HEADER='Footer pages';
?>
<script language="JavaScript1.2" src="js/jlist.js"></script>
<form name="frmlist" method="post" action="footerlinkadd_a.php">
...
<table width="990" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="left" valign="middle"><h2><img src="images/package_icon.jpeg" width="37" height="34" align="absmiddle" />&nbsp;&nbsp;Footer Links </h2></td>
        ...
        <tr>
          <td colspan="2" align="left" valign="top" class="rlborder"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  <a href="index.php?file=footerlinkadd" onClick="#return false;" class="buttonback">Add new page</a>
            ...
            <tr>
			  ...
			  <table width="100%" border="0" cellpadding="8" cellspacing="0">
                <tr>
				  ...
				  <td width="24%" height="25" align="left" valign="middle" class="detailtitle">Page Name</td> 
                </tr>
				<?	for($i=0;$i<count($db_res);$i++)
				{
                 ...
                 <tr class="<?=$bgcolor?>" onMouseOver="Highlight(this)"  onmouseout="UnHighlight(this,'<?=$bgcolor?>')">
                  <td align="center" valign="middle" class="td-listing"><input  type="checkbox" id='iId' name="ch<?php echo $i?>" value="<?php    echo $db_res[$i]["fLid"];?>" ></td>
                  <td align="left" valign="middle" class="td-listing"><a href="index.php?file=footerlinkadd&fLid=<? echo $db_res[$i]["fLid"];?>&mode=Update" class="listlink"><strong><?=$db_res[$i]["fLName"]?></strong></a></td>
                </tr>
                   <?
					}
					?>
