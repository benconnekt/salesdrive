...
$sql="select count(*) as tot from subscribe where 1=1 ".$ssql;
$db_res=$obj->select($sql);	
$num_totrec = $db_res[0]["tot"];

include("middle/paging.inc.php");

$db_query = "select * from subscribe where 1=1  ".$ssql. $var_limit;
...
<form name="frmlist" method="post" action="subscribe_a.php">
...
<table width="990" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="left" valign="middle"><h2><img src="images/category_icon.jpeg" width="37" height="34" align="absmiddle" />&nbsp;&nbsp;Subscribe</h2></td>
        ...
        <tr>
          <td colspan="2" align="left" valign="top" class="rlborder"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  <a href="index.php?file=subscribeadd" onclick="#return false;" class="buttonback">Send Mail To All Customers</a>
            ...
            <tr>
			  ...
			  <table width="100%" border="0" cellpadding="8" cellspacing="0">
                <tr>
                  ...
                  <td width="96%" height="25" align="left" valign="middle" class="detailtitle">Category Name</td>
				...
				<?	for($i=0;$i<count($db_res);$i++)
				{
                 ...
                 <tr class="<?=$bgcolor?>" onMouseOver="Highlight(this)"  onmouseout="UnHighlight(this,'<?=$bgcolor?>')">
                  <td align="center" valign="middle" class="td-listing"><input  type="checkbox" id='iId' name="ch<?php echo $i?>" value="<?php    echo $db_res[$i]["iSubscriID"];?>" ></td>
                  <td align="left" valign="middle" class="td-listing"><strong><?=$db_res[$i]["vSubscriEmail"]?></strong></td>
                </tr>
                   <?
					}
					?>
