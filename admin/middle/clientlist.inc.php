...
$sql="select count(*) as tot from clients where 1=1 ".$ssql;
$db_res=$obj->select($sql);	
$num_totrec = $db_res[0]["tot"];

include("middle/paging.inc.php");

$db_query = "select * from clients ". $var_limit;
...
<form name="frmlist" method="post" action="clientadd_a.php">
        ...
        <tr>
          <td colspan="2" align="left" valign="top" class="rlborder"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  <a href="index.php?file=clientadd" onClick="#return false;" class="buttonback">Add New</a>
            ...
            <tr>
			  ...
			  <table width="100%" border="0" cellpadding="8" cellspacing="0">
                <tr>
				  ...
				  <td width="24%" height="25" align="left" valign="middle" class="detailtitle">Client Name</td>
				  <td width="72%" height="25" align="left" valign="middle" class="detailtitle">URL</td>
				...
				<?	for($i=0;$i<count($db_res);$i++)
				{
                 ...
                 <tr class="<?=$bgcolor?>" onMouseOver="Highlight(this)"  onmouseout="UnHighlight(this,'<?=$bgcolor?>')">
                  <td align="center" valign="middle" class="td-listing"><input  type="checkbox" id='iId' name="ch<?php echo $i?>" value="<?php    echo $db_res[$i]["clientid"];?>" ></td>
                  <td align="left" valign="middle" class="td-listing"><a href="index.php?file=clientadd&clientid=<? echo $db_res[$i]["clientid"];?>&mode=Update" class="listlink"><strong><?=$db_res[$i]["name"]?></strong></a></td>
                  <td align="left" valign="middle" class="td-listing"><?=$db_res[$i]["url"]?></td>
                <td align="left" valign="middle" class="td-listing"><a href="index.php?file=clientadd&clientid=<? echo $db_res[$i]["clientid"];?>&mode=Update" class="listlink"><strong>View/Edit</strong></a></td>
