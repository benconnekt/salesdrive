...
$sql="select count(*) as tot from news where 1=1 ".$ssql;
$db_res=$obj->select($sql);	
$num_totrec = $db_res[0]["tot"];

include("middle/paging.inc.php");

$db_query = "select * from news ". $var_limit;
...
<form name="frmlist" method="post" action="news_a.php">
...
<table width="990" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="left" valign="middle"><h2><img src="images/package_icon.jpeg" width="37" height="34" align="absmiddle" />&nbsp;&nbsp;News List </h2></td>
        ...
        <tr>
          <td colspan="2" align="left" valign="top" class="rlborder"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  <a href="index.php?file=newsadd" onClick="#return false;" class="buttonback">Add New</a>
            ...
            <tr>
			  ...
			  <table width="100%" border="0" cellpadding="8" cellspacing="0">
                <tr>
				  ...
				  <td width="21%" height="25" align="left" valign="middle" class="detailtitle">News Title</td>
			  <td width="75%" height="25" align="left" valign="middle" class="detailtitle">Date</td>	 
             </tr>
				<?	for($i=0;$i<count($db_res);$i++)
				{
                 ...
                 <tr class="<?=$bgcolor?>" onMouseOver="Highlight(this)"  onmouseout="UnHighlight(this,'<?=$bgcolor?>')">
                  <td align="center" valign="middle" class="td-listing"><input  type="checkbox" id='iId' name="ch<?php echo $i?>" value="<?php    echo $db_res[$i]["iNewsId"];?>" ></td>
                  <td align="left" valign="middle" class="td-listing"><a href="index.php?file=newsadd&iNewsId=<? echo $db_res[$i]["iNewsId"];?>&mode=Update" class="listlink"><strong><?=$db_res[$i]["vNewTitle"]?></strong></a></td>
				  <td align="left" valign="middle" class="td-listing"><?=$db_res[$i]["vNewDate"]?></td>
                </tr>
                   <?
					}
					?>
