...
$sql="select count(*) as tot from linkcategory where 1=1 ".$ssql;
$db_res=$obj->select($sql);	
$num_totrec = $db_res[0]["tot"];

include("middle/paging.inc.php");

$db_query = "select * from linkcategory ". $var_limit;
...
<form name="frmlist" method="post" action="linkcategoryadd_a.php">
...
<table width="990" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="left" valign="middle"><h2><img src="images/package_icon.jpeg" width="37" height="34" align="absmiddle" />&nbsp;&nbsp;Link Category </h2></td>
		...
		<a href="index.php?file=linkcategoryadd" onclick="#return false;" class="buttonback">Add New</a>
            ...
            <tr>
			  ...
			  <table width="100%" border="0" cellpadding="8" cellspacing="0">
                <tr>
				  ...
				  <td width="72%" height="25" align="left" valign="middle" class="detailtitle">Category Name</td>
                                
                                  <td width="72%" height="25" align="left" valign="middle" class="detailtitle">Status</td>
				...
				<?	for($i=0;$i<count($db_res);$i++)
				{
                 ...
                 <tr class="<?=$bgcolor?>" onMouseOver="Highlight(this)"  onmouseout="UnHighlight(this,'<?=$bgcolor?>')">
                  <td align="center" valign="middle" class="td-listing"><input  type="checkbox" id='iId' name="ch<?php echo $i?>" value="<?php    echo $db_res[$i]["catid"];?>" ></td>
                  <td align="left" valign="middle" class="td-listing"><a href="index.php?file=linkcategoryadd&catid=<? echo $db_res[$i]["catid"];?>&mode=Update" class="listlink"><strong><?=$db_res[$i]["catname"]?></strong></a></td>
                                  
                 <td align="left" valign="middle" class="td-listing"><a href="index.php?file=linkcategoryadd&catid=<? echo $db_res[$i]["catid"];?>&mode=Update" class="listlink"><strong>View/Edit</strong></a></td>
                 <td align="left" valign="middle" class="td-listing"><? echo $db_res[$i]["status"];?></td>
