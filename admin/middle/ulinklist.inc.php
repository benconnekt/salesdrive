...
$sql="select count(*) as tot from ulinks where 1=1 ".$ssql;
$db_res=$obj->select($sql);	
$num_totrec = $db_res[0]["tot"];

include("middle/paging.inc.php");

$db_query = "select * from ulinks ". $var_limit;
...
$TOP_HEADER='Useful Links';
?>
<script language="JavaScript1.2" src="js/jlist.js"></script>
<form name="frmlist" method="post" action="ulinkadd_a.php">
...
<table width="990" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="left" valign="middle"><h2><img src="images/package_icon.jpeg" width="37" height="34" align="absmiddle" />&nbsp;&nbsp;Useful Links </h2></td>
        ...
        <tr>
          <td colspan="2" align="left" valign="top" class="rlborder"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  <a href="index.php?file=ulinkadd" onClick="#return false;" class="buttonback">Add New</a>
            ...
            <tr>
			  ...
			  <table width="100%" border="0" cellpadding="8" cellspacing="0">
                <tr>
				  ...
				  <td width="30%" height="25" align="left" valign="middle" class="detailtitle">URL</td>
                                  <td width="60%" height="25" align="left" valign="middle" class="detailtitle">Description</td>
                                  <td width="50%" height="25" align="left" valign="middle" class="detailtitle">Category</td>
                                  <td width="30%" height="25" align="left" valign="middle" class="detailtitle">Action</td>
             </tr>
				<?	for($i=0;$i<count($db_res);$i++)
				{
                 ...
                 <tr class="<?=$bgcolor?>" onMouseOver="Highlight(this)"  onmouseout="UnHighlight(this,'<?=$bgcolor?>')">
                  <td align="center" valign="middle" class="td-listing"><input  type="checkbox" id='iId' name="ch<?php echo $i?>" value="<?php    echo $db_res[$i]["uId"];?>" ></td>
                  <td align="left" valign="middle" class="td-listing"><?=$db_res[$i]["utitle"]?></td>
                  <td align="left" valign="middle" class="td-listing"><?=$db_res[$i]["url"]?></td>
                  <td align="left" valign="middle" class="td-listing"><?=  substr($db_res[$i]["udesc"], 0, 350)." ..."?></td>
                  <td align="left" valign="middle" class="td-listing"><?=$db_res[$i]["ucategory"]?></td>
                  <td align="left" valign="middle" class="td-listing"><a href="index.php?file=ulinkadd&uId=<? echo $db_res[$i]["uId"]."&cat=".$db_res[$i]["ucategory"];?>&mode=Update" class="listlink"><strong>View/Edit</strong></a></td>
