...
define ("DB_HOST", "213.171.200.47"); // set database host
define ("DB_USER", "salesdriveconn"); // set database user
define ("DB_PASS","SalesLondonDrive!@707&"); // set database password
define ("DB_NAME","salesdriveuk2012"); // set database name
...
/*************** reCAPTCHA KEYS****************/
$publickey = "6LdID9ESAAAAAKcVxIvE7fRzqeU0ffzgTouABkds";
$privatekey = "6LdID9ESAAAAAH5tt7b2zY7ZMI6nausUFg24BbwI";
